# Add sw version to /etc/os-release
...
echo "MENDELEEV_VERSION=${VERSION}" >> "$TARGET_DIR/etc/os-release" 2> /dev/null
echo "MENDELEEV_DATE=${DATE}" >> "$TARGET_DIR/etc/os-release" 2> /dev/null